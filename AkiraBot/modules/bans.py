...
from AkiraBot.modules.disable import DisableAbleCommandHandler
from AkiraBot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    connection_status,
    is_user_admin,
...
from AkiraBot.modules.helper_funcs.extraction import extract_user_and_text
from AkiraBot.modules.helper_funcs.string_handling import extract_time
from AkiraBot.modules.log_channel import gloggable, loggable
...
@user_can_ban
@loggable
def dkick(update: Update, context: CallbackContext) -> str:
    chat = update.effective_chat
    user = update.effective_user
    message = update.effective_message
    log_message = ""
